...
" NO LONGER USED
" Use Vundle (http://lepture.com/en/2012/vundle-vs-pathogen)
...
" Statusline.
au BufEnter * hi StatusLine guibg=black guifg=white ctermbg=grey ctermfg=black
au BufEnter * hi StatusLineNC guibg=black guifg=gray70 ctermbg=grey ctermfg=white
...
let s:web_browser_path='/opt/google/chrome/chrome'
...
"noremap K :grep! -rn "<C-R><C-W>" include/ d7_h264enc_dispatch/frm_lib/ d7_h264enc_dispatch/frm_app/ d7_h264enc_dispatch/include/ d7_mpg2enc_dispatch/frm_lib/ d7_mpg2enc_dispatch/frm_app/ d7_mpg2enc_dispatch/include/ d7_hevc_enc/frm_lib/ d7_hevc_enc/frm_app/ d7_hevc_enc/include/<CR>:cw<CR>
...
" This is to allow for cscope db to be read from anywhere
set cscoperelative
